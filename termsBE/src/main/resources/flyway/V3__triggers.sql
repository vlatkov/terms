...
FOR EACH ROW
  BEGIN
    ...
    SET @price = (select price from playground_info pi
    ...
    INSERT INTO resertavion_audit (id, user_id, playground_reservation_id, start_time, end_time, price, number_participant)
